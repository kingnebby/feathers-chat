...
const addEventListenerWrapper = (selector, event, handler) => {
...
addEventListenerWrapper('#signup', 'click', async () => {
...
addEventListenerWrapper('#login', 'click', async () => {
...
addEventListenerWrapper('#logout', 'click', async () => {
  await client.logout();
...
addEventListenerWrapper('#send-message', 'submit', async ev => {
